...
import {
  ...
  UserListFollowersV2Paginator,
  UserListMembersV2Paginator,
  UserMutingUsersV2Paginator,
} from "../paginators/user.paginator.v2";
...
import {
  ...
  FullDMTimelineV2Paginator,
  OneToOneDMTimelineV2Paginator,
} from "../paginators/dm.paginator.v2";
...
export default class TwitterApiv2ReadOnly extends TwitterApiSubClient {
  ...
  public async search(
    queryOrOptions: string | Tweetv2SearchParams,
    options: Partial<Tweetv2SearchParams> = {}
  ) {
    const queryParams =
      typeof queryOrOptions === "string"
        ...
        : { ...queryOrOptions };
    const initialRq = await this.get<Tweetv2SearchResult>(
  ...
  public singleTweet(
    tweetId: string,
    options: Partial<Tweetv2FieldsParams> = {}
  ) {
    return this.get<TweetV2SingleResult>("tweets/:id", options, {
      params: { id: tweetId },
    });
  }
  ...
  public tweets(
    ...
    return this.get<TweetV2LookupResult>("tweets", {
      ids: tweetIds,
      ...options,
    });
  }
   ...
   */
  public tweetCountRecent(
    query: string,
    options: Partial<TweetV2CountParams> = {}
  ) {
    return this.get<TweetV2CountResult>("tweets/counts/recent", {
      query,
      ...options,
    });
  }
   ...
   */
  public tweetCountAll(
    query: string,
    options: Partial<TweetV2CountAllParams> = {}
  ) {
    return this.get<TweetV2CountAllResult>("tweets/counts/all", {
      query,
      ...options,
    });
  }
   ...
   */
  public tweetRetweetedBy(
    tweetId: string,
    options?: Partial<TweetRetweetedOrLikedByV2ParamsWithoutPaginator>
  ): Promise<TweetV2RetweetedByResult>;
  public tweetRetweetedBy(
    tweetId: string,
    options: TweetRetweetedOrLikedByV2ParamsWithPaginator
  ): Promise<TweetRetweetersUsersV2Paginator>;
  public async tweetRetweetedBy(
    tweetId: string,
    options: TweetRetweetedOrLikedByV2Params = {}
  ) {
    const { asPaginator, ...parameters } = options;
    const initialRq = await this.get<TweetV2RetweetedByResult>(
  ...
  public tweetLikedBy(
    tweetId: string,
    options: TweetRetweetedOrLikedByV2ParamsWithPaginator
  ): Promise<TweetLikingUsersV2Paginator>;
  public async tweetLikedBy(
    tweetId: string,
    options: TweetRetweetedOrLikedByV2Params = {}
  ) {
    const { asPaginator, ...parameters } = options;
    const initialRq = await this.get<TweetV2LikedByResult>(
  ...
  public async homeTimeline(options: Partial<TweetV2HomeTimelineParams> = {}) {
    ...
    const initialRq = await this.get<TweetV2HomeTimelineResult>(
  ...
  public async userTimeline(
    userId: string,
    options: Partial<TweetV2UserTimelineParams> = {}
  ) {
    const initialRq = await this.get<TweetV2UserTimelineResult>(
      "users/:id/tweets",
      options,
      {
        fullResponse: true,
   ...
   */
  public async userMentionTimeline(
    userId: string,
    options: Partial<TweetV2PaginableTimelineParams> = {}
  ) {
    const initialRq = await this.get<TweetV2UserTimelineResult>(
      "users/:id/mentions",
      options,
  ...
  public async quotes(
    ...
    const initialRq = await this.get<TweetV2PaginableTimelineResult>(
  ...
  public user(userId: string, options: Partial<UsersV2Params> = {}) {
    return this.get<UserV2Result>("users/:id", options, {
      params: { id: userId },
    });
  }
  ...
  public followers(
    userId: string,
    options?: Partial<FollowersV2ParamsWithoutPaginator>
  ): Promise<UserV2TimelineResult>;
  public followers(
    userId: string,
    options: FollowersV2ParamsWithPaginator
  ...
  public async followers(userId: string, options: FollowersV2Params = {}) {
    ...
    if (!asPaginator) {
      return this.get<UserV2TimelineResult>(
        "users/:id/followers",
        parameters as Partial<UserV2TimelineParams>,
        { params }
      );
    }

    const initialRq = await this.get<UserV2TimelineResult>(
      "users/:id/followers",
      parameters as Partial<UserV2TimelineParams>,
      { fullResponse: true, params }
    );
  ...
  public following(
    userId: string,
    options: FollowersV2ParamsWithPaginator
  ): Promise<UserFollowingV2Paginator>;
   ...
   */
  public async userLikedTweets(
    userId: string,
    options: Partial<TweetV2PaginableListParams> = {}
  ) {
    const params = { id: userId };
    const initialRq = await this.get<Tweetv2ListResult>(
   ...
   */
  public async userBlockingUsers(
    userId: string,
    options: Partial<UserV2TimelineParams> = {}
  ) {
    const params = { id: userId };
    const initialRq = await this.get<UserV2TimelineResult>(
      "users/:id/blocking",
   ...
   */
  public async listsOwned(
    userId: string,
    options: Partial<GetListTimelineV2Params> = {}
  ) {
    const params = { id: userId };
    const initialRq = await this.get<ListTimelineV2Result>(
  ...
  public async listDmEvents(options: Partial<GetDMEventV2Params> = {}) {
    const initialRq = await this.get<GetDMEventV2Result>("dm_events", options, {
      fullResponse: true,
    });
   ...
   */
  public async listDmEventsWithParticipant(
    participantId: string,
    options: Partial<GetDMEventV2Params> = {}
  ) {
    const params = { participant_id: participantId };
    const initialRq = await this.get<GetDMEventV2Result>(
   ...
   * https://developer.x.com/en/docs/twitter-api/direct-messages/lookup/api-reference/get-dm_conversations-dm_conversation_id-dm_events
   */
  public async listDmEventsOfConversation(
    dmConversationId: string,
    options: Partial<GetDMEventV2Params> = {}
  ) {
    const params = { dm_conversation_id: dmConversationId };
    const initialRq = await this.get<GetDMEventV2Result>(
      "dm_conversations/:dm_conversation_id/dm_events",
      options,
      { fullResponse: true, params }
    );
  ...
  public space(spaceId: string, options: Partial<SpaceV2FieldsParams> = {}) {
    return this.get<SpaceV2SingleResult>("spaces/:id", options, {
      params: { id: spaceId },
    });
  }
  ...
  public spaces(
    ...
    options: Partial<SpaceV2FieldsParams> = {}
  ) {
    return this.get<SpaceV2LookupResult>("spaces", {
      ids: spaceIds,
      ...options,
    });
  }
   ...
   * OAuth2 scopes: `tweet.read`, `users.read`, `space.read`.
   */
  public spacesByCreators(
    creatorIds: string | string[],
    options: Partial<SpaceV2CreatorLookupParams> = {}
  ) {
    return this.get<SpaceV2LookupResult>("spaces/by/creator_ids", {
      user_ids: creatorIds,
      ...options,
    });
  }
  ...
  public searchSpaces(options: SpaceV2SearchParams) {
    return this.get<SpaceV2LookupResult>(
      "spaces/search",
      options as Partial<SpaceV2SearchParams>
    );
  }
  ...
  public spaceBuyers(
    spaceId: string,
    options: Partial<SpaceV2BuyersParams> = {}
  ) {
    return this.get<SpaceV2BuyersResult>("spaces/:id/buyers", options, {
      params: { id: spaceId },
    });
  }
  ...
  public spaceTweets(
    ...
    return this.get<TweetV2LookupResult>("spaces/:id/tweets", options, {
      params: { id: spaceId },
    });
  }
   ...
   */
  public searchStream(
    options?: Partial<TweetSearchV2StreamParams> & { autoConnect?: true }
  ): Promise<TweetStream<TweetV2SingleStreamResult>>;
  public searchStream(
    options: Partial<TweetSearchV2StreamParams> & { autoConnect: false }
  ): TweetStream<TweetV2SingleStreamResult>;
  public searchStream(
    options?: Partial<TweetSearchV2StreamParams> & { autoConnect?: boolean }
  ): PromiseOrType<TweetStream<TweetV2SingleStreamResult>>;

  public searchStream({
    autoConnect,
    ...options
  }: Partial<TweetSearchV2StreamParams> & { autoConnect?: boolean } = {}) {
    return this.getStream<TweetV2SingleStreamResult>(
      "tweets/search/stream",
      options as any,
      { payloadIsError: isTweetStreamV2ErrorPayload, autoConnect }
    );
  }
  ...
  public streamRules(options: Partial<StreamingV2GetRulesParams> = {}) {
    return this.get<StreamingV2GetRulesResult>(
   ...
   */
  public updateStreamRules(
    options: StreamingV2AddRulesParams,
    query?: Partial<StreamingV2UpdateRulesQuery>
  ): Promise<StreamingV2UpdateRulesAddResult>;
  public updateStreamRules(
    options: StreamingV2DeleteRulesParams,
    query?: Partial<StreamingV2UpdateRulesQuery>
  ): Promise<StreamingV2UpdateRulesDeleteResult>;
  public updateStreamRules(
    options: StreamingV2UpdateRulesParams,
    query: Partial<StreamingV2UpdateRulesQuery> = {}
  ) {
   ...
   */
  public sampleStream(
    options?: Partial<Tweetv2FieldsParams> & { autoConnect?: true }
  ): Promise<TweetStream<TweetV2SingleResult>>;
  public sampleStream(
    options: Partial<Tweetv2FieldsParams> & { autoConnect: false }
  ): TweetStream<TweetV2SingleResult>;
  public sampleStream(
    options?: Partial<Tweetv2FieldsParams> & { autoConnect?: boolean }
  ): PromiseOrType<TweetStream<TweetV2SingleResult>>;

  public sampleStream({
    autoConnect,
    ...options
  }: Partial<Tweetv2FieldsParams> & { autoConnect?: boolean } = {}) {
    return this.getStream<TweetV2SingleResult>(
  ...
  public complianceJobs(options: BatchComplianceSearchV2Params) {
    return this.get<BatchComplianceListV2Result>(
      "compliance/jobs",
      options as Partial<BatchComplianceSearchV2Params>
    );
  }
  ...
  public complianceJob(jobId: string) {
    return this.get<BatchComplianceV2Result>("compliance/jobs/:id", undefined, {
      params: { id: jobId },
    });
  }
  ...
  public async sendComplianceJob(jobParams: BatchComplianceV2Params) {
    const job = await this.post<BatchComplianceV2Result>("compliance/jobs", {
      type: jobParams.type,
      name: jobParams.name,
    });
    ...
    // Send the IDs
    const rawIdsBody =
      jobParams.ids instanceof Buffer
        ? jobParams.ids
        : Buffer.from(jobParams.ids.join("\n"));
    // Upload the IDs
  ...
  public community(
    communityId: string,
    options: Partial<CommunityByIDV2Params> = {}
  ) {
    return this.get<CommunityV2Result>("communities/:id", options, {
   ...
   */
  public searchCommunities(
    query: string,
    options: Partial<CommunitySearchV2Params> = {}
  ) {
    return this.get<CommunitiesV2Result>("communities/search", {
      query,
      ...options,
    });
  }
