...
export type TRequestDebuggerHandlerEvent =
  | "abort"
  | "close"
  | "socket"
  | "socket-error"
  ...
  | "response-close"
  | "response-end";
export type TRequestDebuggerHandler = (
  event: TRequestDebuggerHandlerEvent,
  data?: any
) => void;
 ...
 */
export type TRequestCompressionLevel =
  | boolean
  | "brotli"
  | "gzip"
  | "deflate"
...
export type TRequestFullStreamData = TRequestFullData & {
...
export type TCustomizableRequestArgs = Pick<
  IGetHttpRequestArgs,
  | "forceParseMode"
  | "compression"
  | "timeout"
...
export type TAcceptedInitToken =
  | TwitterApiTokens
  | TwitterApiOAuth2Init
  | TwitterApiBasicAuth
  | string;
